...
public class Global {
	...
	public static final int ERROR_CODE = 5000;			//代码逻辑错误代码

	public static final int VALID_CODE_TIME = 300000;	//短信验证有效时长

	public static final String baseUrl = "http://223.111.103.7";
	...
	/**
	 * @Description: 获取主项目管理根路径	
	 * @return
	 * @author wcf
	 * @date 2016年9月22日
	 */
	public static String getMainPath(){
		return getConfig("mainPath");
	}
