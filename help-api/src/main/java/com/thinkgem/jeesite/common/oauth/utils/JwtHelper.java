package com.thinkgem.jeesite.common.oauth.utils;
...
public class JwtHelper {
    ...
    public static String createJWT(String name, Integer userId,
     ...
     /**    
      * @description 生成后台管理人员登录的token或者refresh_token
      * @param 
      * @author wcf
      * @date 2018/1/23 
      * @return   
      */  
    public static String createAdminJWT(String name, Integer adminId,
                                   String audience, String issuer, long TTLMillis, String base64Security){
        SignatureAlgorithm signatureAlgorithm = SignatureAlgorithm.HS256;
    ...
    /**
     * @Description: 获取后台管理人员的accessToken，有效期为1小时，用于请求用户数据接口
     * @param name
     * @param adminId
     * @param audience
     * @param issuer
     ...
     * @date ： 2017年7月2日
     */
    public static String createAdminToken(String name, Integer adminId,
                                           String audience, String issuer, String base64Security){
        return createAdminJWT(name, adminId, audience, issuer, 3600000, base64Security);
    }
    /**
     * @Description: 获取后台管理人员的refreshToken，有效期7天，仅用于更新accessToken
     * @param name
     * @param adminId
     * @param audience
     * @param issuer
     ...
     * @date ： 2017年7月2日
     */
    public static String creteaAdminRefresh(String name, Integer adminId,
                                            String audience, String issuer, String base64Security){
        return createAdminJWT(name, adminId, audience, issuer, 3600000, base64Security);
    }
}
