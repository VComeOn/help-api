 ...
 * @version 2018-01-15
 */
public class BillDeliveryStatusModel extends DataEntity<BillDeliveryStatusModel> {
	...
	@NotNull
	private Integer status;		// 状态，0：未分配，1：已分配，2：运输中，3：已完成，4：中途停车，5：已到达 6:终止 7：挂起
	...
	public static final int STATUS_TRANSIT = 2;			//运输中
	public static final int STATUS_FINISH = 3;			//已完成
	public static final int STATUS_STOP = 4;			//中途停车
	public static final int STATUS_ARRIVE = 5;			//已到达


	public BillDeliveryStatusModel() {
		super();
	}

	public BillDeliveryStatusModel(Integer id){
		super(id);
	}

	@Length(min=1, max=50, message="运单单号长度必须介于 1 和 50 之间")
