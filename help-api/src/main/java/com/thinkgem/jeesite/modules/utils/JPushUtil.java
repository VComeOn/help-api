...
public class JPushUtil {
    protected static final String APP_KEY ="510378ed0879f242b3ac483c";
    protected static final String MASTER_SECRET = "4e202f8f72a27c50548c36e5";
        ...
        return PushPayload.newBuilder()
                ...
                .setNotification(Notification.newBuilder()
                        ...
                        .addPlatformNotification(IosNotification.newBuilder()       //ios
                                .setAlert(IosAlert.newBuilder().setTitleAndBody(title, null, content).build())      //通知内容
                                .incrBadge(1)   //应用角标+1
                                .setSound("sound.caf")
                                .build())
                        .build())
